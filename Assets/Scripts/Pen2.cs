...
public class Pen2 : MonoBehaviour
{
    ...
    private void Draw()
    {
        if (currentDrawing == null)
        {
            ...
            RadialSelection menu = FindObjectOfType<RadialSelection>();
            currentDrawing.startColor = currentDrawing.endColor = menu.colorList[menu.currentSelectedRadialPart];
